...
const listWithOneBlog = [
  ...
  test('when list no list is given, equal null', () => {
    const result = listHelper.totalLikes()
    assert.strictEqual(result, null)
  })

  test('when list is empty, equal 0', () => {
...
describe('favorite blog', () => {
  ...
  test('when blog list is not provided', () => {
  ...
  test('when blog list has 1 element, return that element', () => {
